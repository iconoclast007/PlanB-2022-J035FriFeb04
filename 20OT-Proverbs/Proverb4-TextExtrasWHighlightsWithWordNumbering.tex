...
[2] \textcolor[cmyk]{0.99998,1,0,0}{For\textcolor{jungle}{$_{1383}$} I give you good doctrine, forsake ye \fcolorbox{bone}{bone}{not} my law.}
...
[5] \textcolor[cmyk]{0.99998,1,0,0}{Get\textcolor{jungle}{$_{1429}$} wisdom, get understanding: forget \emph{it} \fcolorbox{bone}{bone}{not}; neither decline from the words of my mouth.}
[6] \textcolor[cmyk]{0.99998,1,0,0}{Forsake\textcolor{jungle}{$_{1444}$} her \fcolorbox{bone}{bone}{not}, and she shall preserve thee: love her, and she shall keep thee.}
...
[11] \textcolor[cmyk]{0.99998,1,0,0}{I\textcolor{jungle}{$_{1528}$} have taught thee in the way of wisdom; I have led thee in right paths.}
[12] \textcolor[cmyk]{0.99998,1,0,0}{When\textcolor{jungle}{$_{1544}$} thou goest, thy steps shall \fcolorbox{bone}{bone}{not} be straitened; and when thou runnest, thou shalt \fcolorbox{bone}{bone}{not} stumble.}
[13] \textcolor[cmyk]{0.99998,1,0,0}{Take\textcolor{jungle}{$_{1561}$} fast hold of instruction; let \emph{her} \fcolorbox{bone}{bone}{not} go: keep her; for \fcolorbox{bone}{lime}{she \emph{is} thy life}.}\\
\\
\P \textcolor[cmyk]{0.99998,1,0,0}{\fcolorbox{bone}{lime}{Enter\textcolor{jungle}{$_{1577}$} \fcolorbox{bone}{bone}{not}} into the path of the wicked, and go \fcolorbox{bone}{bone}{not} in the way of evil \emph{men}.}
[15] \textcolor[cmyk]{0.99998,1,0,0}{Avoid\textcolor{jungle}{$_{1394}$} it, pass \fcolorbox{bone}{bone}{not} by it, \fcolorbox{bone}{lime}{turn from it}, and pass away.}
[16] \textcolor[cmyk]{0.99998,1,0,0}{For\textcolor{jungle}{$_{1606}$} they sleep \fcolorbox{bone}{bone}{not}, except they have done mischief; and their sleep is taken away, unless they cause \emph{some} to fall.}
...
[18] \textcolor[cmyk]{0.99998,1,0,0}{But\textcolor{jungle}{$_{1640}$} the path of the just \emph{is} as the \fcolorbox{bone}{lime}{shining light}, that shineth more and more unto the perfect day.}
[19] \textcolor[cmyk]{0.99998,1,0,0}{The\textcolor{jungle}{$_{1660}$} way of the wicked \emph{is} as \fcolorbox{bone}{lime}{darkness}: they know \fcolorbox{bone}{bone}{not} at what they stumble.}\\
\\
\P \textcolor[cmyk]{0.99998,1,0,0}{My\textcolor{jungle}{$_{1675}$} son, attend to my words; incline thine ear unto my sayings.}
[21] \textcolor[cmyk]{0.99998,1,0,0}{Let\textcolor{jungle}{$_{1687}$} them \fcolorbox{bone}{bone}{not} depart from thine eyes; keep them in the midst of thine heart.}
[22] \textcolor[cmyk]{0.99998,1,0,0}{For\textcolor{jungle}{$_{1702}$} \fcolorbox{bone}{lime}{they \emph{are} life} unto those that find them, and health to all their flesh.}\\
\\
\P \textcolor[cmyk]{0.99998,1,0,0}{Keep\textcolor{jungle}{$_{1717}$} thy heart with all \fcolorbox{bone}{lime}{diligence}; for out of it \emph{are} the issues of life.}
...
[27] \textcolor[cmyk]{0.99998,1,0,0}{Turn\textcolor{jungle}{$_{1773}$} \fcolorbox{bone}{bone}{not} to the right hand nor to the left: remove thy foot from evil\textcolor{jungle}{$_{1787}$}.}
